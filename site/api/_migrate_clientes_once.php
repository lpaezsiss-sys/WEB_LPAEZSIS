<?php
/**
 * One-shot: create `clientes` table on BlueHosting.
 * Call once after deploy, then replace with 404 stub.
 */
...
try {
    ...
    echo json_encode(['ok' => true, 'table' => 'clientes', 'rows' => $count], JSON_UNESCAPED_UNICODE);
} catch (Throwable $e) {
