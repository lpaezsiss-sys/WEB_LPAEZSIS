...
final class PublicApi
{
    ...
    /** Lista plana de productos para api/productos.php (filtra por ?brand=). */
    private static function productosList(): void
    {
        // Reutiliza products() y aplana la respuesta.
        ...
        // tipo es opcional: si la columna no existiera en algún entorno, no forzar.
        ...
        // Array plano (el front de marcas espera un JSON array).
        Response::json($rows);
    }
