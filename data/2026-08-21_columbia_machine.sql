...
SELECT c.id, b.id,
  ...
  'quote', 'on_request', NULL, '/img/products/fl3000_columbia.jpg', 1, 1,
...
SELECT c.id, b.id,
  ...
  'quote', 'on_request', NULL, '/img/products/hl7200_columbia.jpg', 1, 1,
...
SELECT c.id, b.id,
  ...
  'quote', 'on_request', NULL, '/img/products/ai1800_columbia.jpg', 1, 1,
...
SELECT c.id, b.id,
  ...
  'quote', 'on_request', NULL, '/img/products/fl1000sw_columbia.jpg', 1, 1,
...
UPDATE `products` SET `image_url` = '/img/products/fl3000_columbia.jpg' WHERE `slug` = 'paletizador-nivel-inferior-columbia-fl3000';
UPDATE `products` SET `image_url` = '/img/products/hl7200_columbia.jpg' WHERE `slug` = 'paletizador-alto-nivel-columbia-hl7200';
UPDATE `products` SET `image_url` = '/img/products/ai1800_columbia.jpg' WHERE `slug` = 'celda-paletizado-robotico-columbia-ai1800';
UPDATE `products` SET `image_url` = '/img/products/fl1000sw_columbia.jpg' WHERE `slug` = 'paletizador-compacto-envolvedora-columbia-fl1000sw';
