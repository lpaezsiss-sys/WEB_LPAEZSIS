...
SELECT c.id, b.id,
  ...
  'quote', 'on_request', NULL, '/img/products/columbia-fl3000.png', 1, 1,
...
SELECT c.id, b.id,
  ...
  'quote', 'on_request', NULL, '/img/products/columbia-hl7200.png', 1, 1,
...
SELECT c.id, b.id,
  ...
  'quote', 'on_request', NULL, '/img/products/columbia-ai1800.png', 1, 1,
...
SELECT c.id, b.id,
  ...
  'quote', 'on_request', NULL, '/img/products/columbia-fl1000sw.png', 1, 1,
